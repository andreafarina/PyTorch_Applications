...
#change to "cpu" if you don't have cuda installed !
...
#optimizer = torch.optim.SGD(model.parameters(), lr=1e-7, weight_decay=0.01)
...
for t in range(10000):
    ...
    # Forward pass: compute predicted im_pred by passing 
    #the ground thoruth image to the model.
    im_pred = model(im)
